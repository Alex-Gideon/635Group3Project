...
`registry.codeocean.com/published/248715d9-1af7-4e81-8afb-a585add00089:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/248715d9-1af7-4e81-8afb-a585add00089:v1 bash run
```
